...
public class DashboardPageTestWithUserAdmin extends TestBase {
    ...
    @Test(priority = 1)
    public void verifyLoginWithUserAdmin() {
        Log.info("User is trying to login to the system");
        String userName = reader.getCellData("LoginTestData", 3, "username");
        String password = reader.getCellData("LoginTestData", 3, "password");
        String captcha = reader.getCellData("LoginTestData", 3, "captcha");
        ...
        String expectedWelcomeMessage = prop.getProperty(Constants.ASSERTIONCONSTANT.EXPECTEDWELCOMETEXT1);
        ...
        softAssert.assertEquals(actualWelcomeMessage, expectedWelcomeMessage, "User is not Admin");
    ...
    public void verifyAndValidateSearchTab() throws InterruptedException {
        Log.info("User is trying to login to the system");
        String userName = reader.getCellData(Constants.EXCEL.SHEETNAME, 3, Constants.EXCEL.USERNAME);
        String password = reader.getCellData(Constants.EXCEL.SHEETNAME, 3, Constants.EXCEL.PASSWORD);
        String captcha = reader.getCellData(Constants.EXCEL.SHEETNAME, 3, Constants.EXCEL.CAPTCHA);
        FbMachineUIActions.getLoginUserCredentialsDetails(userName, password, captcha);
        ...
        softAssert.assertEquals(actualURL1, expectedURL1, "Admin do not have access to Search ");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateCreateUserTab() throws InterruptedException {
        ...
        if(actualStatus == false){
            Log.info("Is Admin have an access to Create User :- " + actualStatus);
        }

        softAssert.assertEquals(actualStatus, expectedStatus, "Admin  have access to Create User");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateEditUserTab() throws InterruptedException {
        ...
        if(actualStatus == false){
            Log.info("Is Admin have an access to Edit User :- " + actualStatus);
        }
        softAssert.assertEquals(actualStatus, expectedStatus, "Admin  have access to Edit User");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateAdsCreatedTab() throws InterruptedException {
        ...
        Log.info("Is Admin have an access to Ads Created :- " + actualStatus);
    ...
    public void verifyAndValidateTemplateTab() throws InterruptedException {
        ...
        softAssert.assertEquals(actualURL1, expectedURL1, "Admin do not have access to create template");
        softAssert.assertAll();
    }
    @Test(priority = 7)
    public void verifyAndValidatePromoDashTab() throws InterruptedException {
        ...
        boolean expectedStatus = true;
        boolean actualStatus = FbMachineUIActions.isAccessToAdsCreated();
        Log.info("Is Admin have an access to Promo Dashboard :- " + actualStatus);

        softAssert.assertEquals(actualStatus, expectedStatus, "Admin do not have access to Promo Dashboard");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidatePromoTab() throws InterruptedException {
        ...
        softAssert.assertEquals(actualURL1, expectedURL1, "Admin do not have access to Promo ads");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateResourcesTab() throws InterruptedException {
        ...
        softAssert.assertEquals(actualUrl1,expectedUrl1,"Admin do not have access to Resources");
        softAssert.assertAll();
    }
