...
public class DashboardPageTestForUserSuperAdmin extends TestBase {
    ...
    @Test(priority = 1)
    public void verifyLoginWithUserSuperAdmin() {
        Log.info("User is trying to login to the system");
        String userName = reader.getCellData(Constants.EXCEL.SHEETNAME, 2, Constants.EXCEL.USERNAME);
        String password = reader.getCellData(Constants.EXCEL.SHEETNAME, 2, Constants.EXCEL.PASSWORD);
        String captcha = reader.getCellData(Constants.EXCEL.SHEETNAME, 2, Constants.EXCEL.CAPTCHA);
        ...
        softAssert.assertEquals(actualWelcomMessage, expectedWelcomMessage, "This user is not Super Admin");
    ...
    public void verifyAndValidateSearchTab() throws InterruptedException {
        ...
        softAssert.assertEquals(actualURL1, expectedURL1, "Super Admin do not have access to Search ");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateCreateUserTab() throws InterruptedException {
        ...
        String expectedURL1 = prop.getProperty(Constants.ASSERTIONCONSTANT.EXPECTEDCREATEUSERURL);
        String actualURL1 = driver.getCurrentUrl();
        Log.info("Current URL is " + actualURL1);

        softAssert.assertEquals(actualURL1, expectedURL1, "Super Admin do not have access to create user");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateEditUserTab() throws InterruptedException {
        ...
        String expectedURL1 = prop.getProperty(Constants.ASSERTIONCONSTANT.EXPECTEDEDITUSERURL);
        String actualURL1 = driver.getCurrentUrl();
        Log.info("Current URL is " + actualURL1);

        softAssert.assertEquals(actualURL1, expectedURL1, "Super Admin do not have access to edit user");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateAdsCreatedTab() throws InterruptedException {
        ...
        Log.info("User is navigating to Ad Created");
        ...
        Log.info("Is Super Admin has an access to Ads Created :- " + actualStatus);

        softAssert.assertEquals(actualStatus, expectedStatus, "Super Admin do not have access to view created ads");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateTemplateTab() throws InterruptedException {
        ...
        String expectedURL1 = prop.getProperty(Constants.ASSERTIONCONSTANT.EXPECTEDTEMPLATEURL);
        String actualURL1 = driver.getCurrentUrl();
        Log.info("Current URL is " + actualURL1);

        softAssert.assertEquals(actualURL1, expectedURL1, "Super Admin do not have access to create template");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidatePromoDashTab() throws InterruptedException {
        ...
        boolean expectedStatus = true;
        boolean actualStatus = FbMachineUIActions.isAccessToAdsCreated();
        Log.info("Is Super Admin have access to Promo Dashboard :- " + actualStatus);

        softAssert.assertEquals(actualStatus, expectedStatus, "Super Admin do not have access to Promo Dashboard");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidatePromoTab() throws InterruptedException {
        ...
        softAssert.assertEquals(actualURL1, expectedURL1, "Super Admin do not have access to Promo Ads");
        softAssert.assertAll();
    }
    ...
    public void verifyAndValidateResourcesTab() throws InterruptedException {
        ...
        Log.info("User is naving to Resources");
        ...
        softAssert.assertEquals(actualUrl1, expectedUrl1, "Super admin do not have access to Resources");
        softAssert.assertAll();
    }
